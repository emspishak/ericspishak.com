...
<ul>
  ...
  <li>
    <strong>Spishak-Thomas, A.</strong>, Slopen, M. Making Work Pay (the Rent):
    Does the Earned Income Tax Credit Affect Housing Mobility among Low Income
    Workers. Association for Public Policy Analysis and Management, Washington,
    D.C., 2020. (In person meeting cancelled due to COVID-19).
  </li>
  <li>
    Kaplan, D. (presenting), Silverstone, B., Chan, K., <strong>Spishak-Thomas,
    ...
    Gerontological Society of America, Philadelphia, PA, 2020. (In person meeting
    cancelled due to COVID-19).
  </li>
  <li>
    Allen, H., Zhang, Y. (presenting), Eliason, E., <strong>Spishak-Thomas, A.</strong>,
    Frankel, C. Adverse Childhood Experiences and their Relationship with
    Depression among Adults in a Low-Income Uninsured Population. Society for
    Social Work and Research, Washington, D.C., 2020.
  </li>
  <li>
    Price E. (presenting), Garg M., <strong>Spishak-Thomas A.</strong>, Crevensten H., Ranji,
